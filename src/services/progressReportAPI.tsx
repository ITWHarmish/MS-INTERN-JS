...
export const AddUserReportDetails = async (payload: IProgressReport) => {
    try {
        const response = await axios.post(`${API_END_POINT}/progressReport`, payload, {
...
export const AddTaskToProgressReport = async (payload: IProgressReport) => {
    try {
        const response = await axios.put(`${API_END_POINT}/progressReport/tasks`, payload, {
            headers: getAuthHeaders(),
        }
        );
        return response.data;
...
export const UpdateTaskToProgressReport = async (taskId: string, payload: IProgressReport) => {
    try {
        const response = await axios.put(`${API_END_POINT}/progressReport/tasks/${taskId}`, payload, {
            headers: getAuthHeaders(),
        }
        );
        return response.data;
...
export const DeleteTaskToProgressReport = async (taskId: string, reportId: string) => {
    try {
        const response = await axios.delete(`${API_END_POINT}/progressReport/tasks/${taskId}`, {
            headers: getAuthHeaders(),
            params: { reportId },
        }
        );
...
export const DeleteProgressReport = async (reportId: string) => {
    try {
        const response = await axios.delete(`${API_END_POINT}/progressReport/${reportId}`, {
            headers: getAuthHeaders(),
        }
        );
        return response.data;
...
export const UpdateUserDetailsProgressReport = async (reportId: string, payload: IProgressReport) => {
    try {
        const response = await axios.put(`${API_END_POINT}/updateProgressReport/${reportId}`, payload, {
            headers: getAuthHeaders(),
        }
        );
        return response.data;
...
export const AddSelfEvaluation = async (reportId: string, payload: IProgressReport) => {
    try {
        const response = await axios.put(`${API_END_POINT}/progressReport/selfEvaluation/${reportId}`, payload, {
            headers: getAuthHeaders(),
        }
        );
        return response.data;
...
export const UpdateProgressReportStatus = async (reportId: string, payload: IProgressReport) => {
    try {
        const response = await axios.put(`${API_END_POINT}/progressReport/status/${reportId}`, payload, {
            headers: getAuthHeaders(),
        }
        );
        return response.data;
...
export const GetRegularity = async (reportId: string) => {
    try {
        const response = await axios.get(`${API_END_POINT}/progressReport/regularity/${reportId}`, {
            headers: getAuthHeaders(),
        }
        );
        return response.data;
...
export const GetPunctuality = async (reportId: string) => {
    try {
        const response = await axios.get(`${API_END_POINT}/progressReport/punctuality/${reportId}`, {
            headers: getAuthHeaders(),
        }
        );
        return response.data;
...
export const GetRemark = async (remarkPayload) => {
    try {
        const response = await axios.post(`${API_END_POINT}/progressReport/remark`, remarkPayload, {
            headers: getAuthHeaders(),
        }
        );
        return response.data;
