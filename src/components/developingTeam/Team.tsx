...
const data = [
  {
    ...
    description:
      "We're giving interns the freedom to be creative with their tasks, and management the minimal amount of involvement needed to look like we know what's going on.",
  ...
  },
  {
    ...
    description:
      "Full Stack Developer with hands-on experience in building web apps using React and Node.js. I focus on clean UI, smooth user experience, and smart backend logic",
  ...
  },
  {
    ...
    role: "FULL STACK DEVELOPER",
    description:
      "Contributed to key features in MS-Intern (InternFlow), including task management, leave requests, HR policies, and role-based access control. Integrated Google APIs for enhanced functionality, developed seamless Telegram integrations for daily updates, and optimized admin features to improve workflow and user experience.",
  ...
  },
  {
    ...
    description:
      "As a UI/UX developer, I designed the TimeLog system with a clean, intuitive interface that makes time tracking effortless. Focused on usability and simplicity, the UI helps users stay productive and organized with ease.",
                ...
                >
                  <div style={{ fontSize: "14px" }}>
                    ...
                    <img
                      ...
                      alt=""
                    />
                    <p style={{ fontSize: "18px" }}>{current.description}</p>
                    <p style={{ fontSize: "18px" }}>{current?.tag}</p>
                  </div>
