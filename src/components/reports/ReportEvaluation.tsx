                ...
                <Form form={form} onFinish={handleSubmit} layout="vertical">
                    ...
                    <Col span={12}>
                      <Form.Item
                        ...
                        rules={[
                          {
                            required: true,
                            message: "Regularity is required!",
                          },
                        ]}
                      >
                      ...
                      <Form.Item
                        ...
                        rules={[
                          {
                            required: true,
                            message: "Punctuality is required!",
                          },
                        ]}
                      >
                        <Select
                      ...
                      <Form.Item
                        ...
                        rules={[
                          {
                            required: true,
                            message: "Implementation Ability is required!",
                          },
                        ]}
                      >
                        <Select
                    ...
                    <Col span={12}>
                      <Form.Item
                        ...
                        rules={[
                          {
                            required: true,
                            message: "Learning Ability is required!",
                          },
                        ]}
                      >
                        <Select
                  ...
                  >
                    <Input
                      ...
                      placeholder="1."
                      style={{ height: "40px" }}
                      onChange={(e) => updateRemark(0, e.target.value)}
                    />
                    <Input
                      name="remark2"
                      value={remarks[1]}
                      ...
                      onChange={(e) => updateRemark(1, e.target.value)}
                    />
                    <Input
                      name="remark3"
                      value={remarks[2]}
                      placeholder="3."
                      style={{ marginTop: "8px", height: "40px" }}
                      onChange={(e) => updateRemark(2, e.target.value)}
                    />
                    <Input
                      name="remark4"
                      value={remarks[3]}
                      placeholder="4."
                      style={{ marginTop: "8px", height: "40px" }}
                      onChange={(e) => updateRemark(3, e.target.value)}
                    />
                  </Form.Item>
                </Form>
              </Card>
