      ...
      {loading ? (
        ...
        <div style={{ padding: "20px" }}>
            ...
            <div>
              <div style={{ marginBottom: "7px" }}>
                <label>
                  ...
                  <span style={{ color: "white" }}>Date Range</span>
                </label>
                <br />
              </div>
              <RangePicker
              ...
              />
              {error && !dateRange && error === "Date range is required" && (
          ...
          <div style={{ display: "flex", justifyContent: "flex-end" }}>
            ...
            <Button type="primary" onClick={handleApplyLeave} loading={loading}>
              Apply Leave
            </Button>
          </div>
        </div>
