      ...
      <div className={styles.content}>
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            MS-Intern, a web-based internship management platform that helps
            organizations and interns manage tasks, communications, and
        ...
        <section className={styles.section}>
          ...
          <ul className={styles.infoList}>
            <li>
              <strong>Developer Name:</strong> Harsh Patel
            </li>
            <li>
              <strong>Support Email:</strong> itw.harshp@gmail.com
            </li>
            <li>
              <strong>Developer Contact Email:</strong> itw.harshp@gmail.com
            </li>
            <li>
        ...
        <section className={styles.section}>
          ...
          <p>
            MS-Intern is a web-based internship management platform designed to
            streamline the internship experience for both organizations and
            interns. The application provides features such as:
          </p>
          <ul>
          ...
          <p>
            Our application integrates with Google services like Gmail, Google
            Chat, and Google Sheets to provide these features.
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            or other entity, you represent and warrant that you are authorized
            to do so and have the authority to bind such entity to these Terms.
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            account using your Google credentials. By registering, you agree to:
          </p>
          <ol>
          ...
          <ol>
            ...
            <li>
              Use the Services only for legitimate internship management
              purposes
            </li>
            <li>
              Not attempt to bypass any security measures or access unauthorized
        ...
        <section className={styles.section}>
          ...
          <ol>
            ...
            <li>
              Attempt to reverse engineer, decompile, or disassemble any portion
              of our Services
            </li>
            <li>
          ...
          <p>
            Any content you submit through our Services must comply with the
            following standards:
          </p>
          <ol>
            ...
            <li>
              It must not contain any material that is defamatory, obscene,
              offensive, hateful, or inflammatory
            </li>
            <li>
              It must not infringe on any copyright, trademark, or other
              intellectual property right
            </li>
            <li>
              It must not violate any person's privacy or contain personal data
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            to our Services, you grant us a worldwide, non-exclusive,
            royalty-free license to use, copy, modify, and display the User
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            when you use our Services. By using our Services, you consent to our
            collection, use, and sharing of information as described in our
            Privacy Policy.
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p className={styles.legal}>
            ...
            THAT THE SERVICES WILL BE UNINTERRUPTED OR ERROR-FREE, THAT DEFECTS
            WILL BE CORRECTED, OR THAT THE SERVICES ARE FREE OF VIRUSES OR OTHER
            HARMFUL COMPONENTS.
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p>
            We may, in our sole discretion, suspend or terminate your access to
            all or part of our Services for any or no reason, including without
            limitation, any violation of these Terms.
          </p>
          <p>
            If you wish to terminate your account, you may simply discontinue
            using our Services or contact us at itw.harshp@gmail.com with your
            request.
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            construed in accordance with the laws of Gujarat, India, without
            giving effect to any choice or conflict of law provision or rule.
          </p>
          <p>
            Any legal suit, action, or proceeding arising out of, or related to,
            these Terms or the Services shall be instituted exclusively in the
            courts located in Surat, Gujarat, India. You waive any and all
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            agreement between you and us regarding your use of the Services and
          ...
          <p>
            ...
            enforceable, and the remaining provisions of these Terms will remain
          ...
          <p>
            ...
            void. We may assign or transfer these Terms, at our sole discretion,
            without restriction.
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            email address associated with your account or through a notification
            within the Services. By continuing to access or use our Services
            after revisions become effective, you agree to be bound by the
            revised Terms. If you do not agree to the new Terms, you must stop
            using the Services.
          </p>
        </section>
      </div>
